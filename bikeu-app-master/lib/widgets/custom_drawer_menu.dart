      ...
      builder: (context){
        ...
        return AlertDialog(
           shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20.0)),
               ...
               content: Column(
                 mainAxisSize: MainAxisSize.min,//reducen el modal al minimo ancho
                 children: [
                   Container(
                     margin: EdgeInsets.only(top: 20),
                     child: Text('¿Seguro que quieres Registrarte ')),
                   Container(
                     margin: EdgeInsets.only(top: 20),
                     child: Text('como BICEMENSAJERO?')),
