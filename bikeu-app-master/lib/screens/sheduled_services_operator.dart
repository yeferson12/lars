...
class SheduledServicesOperator extends StatefulWidget {
  @override
  _SheduledServicesOperatorState createState() => _SheduledServicesOperatorState();
}

class _SheduledServicesOperatorState extends State<SheduledServicesOperator> {
        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                Text("Servicios Programados", style: titleGreenDarkColor2,),
