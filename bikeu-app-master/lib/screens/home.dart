...
class _HomeState extends State<Home> {
  ...
  TextEditingController _insertAddress =new TextEditingController();
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            context: context,
            apiKey: "AIzaSyBsmPREx2HnpcoJ6ts_usHly-P-l3VI3F8",
            mode: Mode.overlay, // Mode.overlayr
            language: "es",
            components: [ Component(Component.country, "co")]);

            if ( prediction != null ){
              setState(() {
                _direccion =prediction.toString();
               destinationAddressController.text = _direccion;  
      });
    }
